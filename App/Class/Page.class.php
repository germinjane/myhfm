 ...
 */
	...
	class Page {
		...
		private function prev(){
			...
			if($this->type){
				$html = '<li><a data-p="'.$page.'" href="javascript:void(0)"><span>&laquo;</span></a></li>';
			}else{
		...
		private function pageList(){
			...
			for($i=$inum; $i>=1; $i--){
				...
				if($page<1) continue;
				if($this->type){
					$linkPage .= '<li><a data-p="'.$page.'" href="javascript:void(0)"><span>'.$page.'</span></a></li>';					
				}else{
		...
		private function next(){
			...
			if($this->type){
				$html = '<li><a data-p="'.$page.'" href="javascript:void(0)"><span>&raquo;</span></a></li>';
			}else{
