		...
		<div class="row">
			<div class="col-md-12">
				<div class="ibox-content">
					...
					<h1 class="text-center">- 登陆（管理后台） -</h1>
					<form name="theForm" id="theForm" class="m-t-lg" role="form" method="POST">
						...
						<div class="form-code-box">
							<div class="row">
								...
								<div class="col-md-8">
									<img src="<?php echo U('admin/login/vertify');?>" style="width:70px;" id="imgVerify" alt="" onClick="fleshVerify()">
...
function fleshVerify(){
	$('#imgVerify').attr('src','/admin/login/vertify?rand='+Math.floor(Math.random()*100));//重载验证码
}
