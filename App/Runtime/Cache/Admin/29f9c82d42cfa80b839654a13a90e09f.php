        ...
        <div class="col-md-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div class="row m-t">
                        <div class="col-md-12">
                            <form class="form-horizontal" action="/admin/user/edit_user/" method="post" >
                               <input type="hidden"value="<?php echo ($res["id"]); ?>" id="id" name="id">	
                                <div class="form-group">
                                    <label class="col-md-2 control-label">用户名:</label>
                                    <div class="col-md-6">
                                    	<input type="text" class="form-control input-sm" placeholder="用户名" value="<?php echo ($res["username"]); ?>" id="username" name="username">									
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                    	<input type="text" class="form-control input-sm" placeholder="密码" id="password" name="password">									
                                    </div>
                ...
                <input type="text" class="form-control datePicker" name="last_time" style="color: red;" value="<?php echo ($res["last_time"]); ?>" id="last_time" placeholder="授权时间">
              </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                    	<input type="text" class="form-control input-sm" placeholder="备注"  value="<?php echo ($res["beizhu"]); ?>"  id="beizhu" name="beizhu">
