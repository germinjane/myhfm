        ...
        <div class="col-md-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div>
                        <p><b>系统名称:</b>名药汇员工花名册系统<a href="#" target="iframeContent">更新日志</a></p>
	                    <p style="color: red"><b style="color: red">系统公告:</b>为了更好使用系统，请用谷歌或者火狐登陆系统<br/>
						</p>
						 <p>自动任务：  http://d.looktp.cn/admin/automaticsyn</p>
	                    <div class="hr-line-dashed"></div>

                        <p><b style="color: red">注意事项:</b>如有任何疑问请联系客服,谢谢您的使用。</p>
                        <p>支持浏览器：谷歌，火狐，360，IE<!--、好搜、搜狗、神马--></p>
                        <div class="hr-line-dashed"></div>
...
<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=574582516&amp;site=qq&amp;menu=yes" rel="external nofollow" title="" target="_blank" data-original-title="联系QQ"><i class="qq fa fa-qq"></i>						574582516</a>  
						 ...
						 <p>有任何疑惑或者建议也请联系客服,您的支持是我们前进的动力.</p>
                    </div>
                </div>
            </div>
        </div>
