...
<div id="grop">
  <div id="wrapper">
    ...
    <!--      <li> <a href="/user/index/welcome.html" target="iframeContent"><i class="fa fa-dashboard"></i> <span class="nav-label">后台首页</span> </a> </li>-->
          <!-- <li> <a href="/user/CountData/bd_list.html" target="iframeContent"><i class="fa fa-shopping-cart"></i> <span class="nav-label">百度统计</span> </a> </li> -->
          <li> <a href="/user/userset/user_list.html" target="iframeContent"><i class="fa fa fa-user"></i> <span class="nav-label">员工花名册</span> </a> </li>
          <!-- <li> <a href="/user/userset/readme.html" target="iframeContent"><i class="fa fa-dashboard"></i> <span class="nav-label">使用说明</span> </a> </li> -->
        </ul>
      </div>
    </nav>
  </div>
  ...
  <div id="page-wrapper" class="gray-bg" style="padding: 0">
    ...
    <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0;background-color: #dadada;" id="frameHeader">
      ...
      <ul class="nav navbar-top-links navbar-right">
        <li> <span class="m-r-sm text-muted welcome-message" style="color: #1c84c6;">欢迎 <b style="color:#000000"><?php echo ($userinfo["username"]); ?></b> <!-- 使用本系统，您的账户有效期：<?php echo ($userinfo["last_time"]); ?> --></span> </li>
        <li> <a href="<?php echo U('user/userset/updatepwd', array('id'=>$userinfo['id']));?>" target="iframeContent"> 修改密码 </a> </li>
        <li> <a href="/user/login/logout.html"> <i class="fa fa-sign-out"></i>退出 </a> </li>
      </ul>
    </nav>
    <!--页面内容-->
    <div id="frameContent" style="height: 800px;">
      <!--content这里加内容-->
     <!-- <iframe src="/user/index/welcome.html" name="iframeContent" width="100%" height="100%" frameborder="0"> </iframe>-->
        <iframe src="/user/userset/user_list.html" name="iframeContent" width="100%" height="100%" frameborder="0"> </iframe>
    </div>
    <!--页脚-->
    <div class="footer text-center" style="margin-bottom: 0" id="frameFooter">
      <div> <strong>&copy;技术支持 24小时在线客服:
						...
						<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=574582516&amp;site=qq&amp;menu=yes" rel="external nofollow" title="" target="_blank" data-original-title="联系QQ"><i class="qq fa fa-qq"></i>574582516</a></strong> </div>
    </div>
  </div>
</div>
</body>
