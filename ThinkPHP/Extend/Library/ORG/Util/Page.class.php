...
class Page {
    ...
    public function show() {
        ...
        if($this->config['widget']['JumpPage']){
            $jumppage='<select onchange="var PageJumpUrl=\''.$url.'\';window.location=PageJumpUrl.replace(\'__PAGE__\',this.value);" style="width:50px;height:30px;border:1px solid #ccc;border-radius:3px;line-height:30px;padding-left:5px;">';
